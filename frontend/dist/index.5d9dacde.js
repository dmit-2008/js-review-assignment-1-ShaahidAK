...
var _jobsJs = require("./api/jobs.js");
// your code goes here.
...
(0, _jobsJs.getJobsList)().then((data)=>{
...
function viewJobDetailsButtonClicked(e) {
    ...
    if (e.target.classList.contains("view-job-button")) {
        ...
        (0, _jobsJs.getJobDetailsById)(jobId).then((jobsData)=>{
            //display job
...
},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","./api/jobs.js":"4xzGm"}],"i5LP7":[function() {},{}],"4xzGm":[function(require,module,exports) {
// your code goes here.
...
},{}]},["fQFrJ","1Z4Rq"], "1Z4Rq", "parcelRequire10c2")
